...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            //  TUNA CODE 1 Rotate canvas to 90 degrees
...
// Use bitmap instead of mCacheBitmap
                    ...
                    canvas.drawBitmap(bitmap, new Rect(0,0,bitmap.getWidth(), bitmap.getHeight()),
                            new Rect((canvas.getWidth() -  (int)mScale*bitmap.getWidth()) / 2,
                                    (canvas.getHeight() - (int)mScale*bitmap.getHeight()) / 2,
                                    (canvas.getWidth() - (int)mScale*bitmap.getWidth()) / 2 + bitmap.getWidth(),
                                    (canvas.getHeight() - (int)mScale*bitmap.getHeight()) / 2 + bitmap.getHeight()), null);
